...
path('classes/<int:pk>/', views.class_dashboard, name='class_dashboard'),
    ...
    path('report/<int:pk>/exam/<int:exam_id>/', views.report_detail, name='report_detail_by_exam'),
    ...
    # TEACHER - THIS IS WHAT YOU NEEDED
...
path('classes/', views.class_list, name='class_list'), # make a separate page for all classes
]